...
Customer_ID : <input type ="text" value =<%=session.getAttribute("customer")%> name="customer_id"  readonly >
<br/>
<br/>
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
<button type ="submit" name ="action" value="viewbalance"><b>VIEW BALANCE</b></button>
</font>
</form>
</div>
</body>
