...
Customer ID : <input type ="text" value =<%=session.getAttribute("customer")%>  name="customer_id"  readonly >

<br/>
<br/>
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
<button type ="submit" name ="action" value="viewdetails"><b>VIEW DETAILS</b></button>
</font>
