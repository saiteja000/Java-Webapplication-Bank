...
New Password :&emsp;&emsp;&emsp;&emsp;&emsp; <input type ="password" name="newpsw" id ="amount">
<br/>
<br/>

Confirm Password : &emsp;&emsp;&emsp;&emsp;<input type ="password"   name="confirmpsw" id="confirmpsw"  >
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br/>
<br/>
<br/>
<br/>
<div align="center">
<button type ="submit" name ="action" value="changepsw"><b>OK</b></button>
</font>
</div>
</form>
</div>
