...
<center><b>Mini Statement</b></center> 
<table border=1>
<tr>
<th>DateOfTransfer</th>
<th>Sendersaccount_id</th>
<th>Receiversaccount_id</th>
<th>Amount</th>
</tr>
<c:forEach items="${mslist}" var="stmtlist">
<tr>
<td><c:out value="${stmtlist.dateOfTransfer}"></c:out></td>
<td><c:out value="${stmtlist.sendersaccount_id}"></c:out></td>
<td><c:out value="${stmtlist.receiversaccount_id}"></c:out></td>
<td><c:out value="${stmtlist.amount}"></c:out></td>
</tr>
</c:forEach>
</table>
</form>
