...
Customer ID :&emsp;&emsp; <input type ="text" value ="${sessionScope.customer}"  name="customer_id"  readonly >

<br/>
<br/>
End Date : &emsp;&emsp;&emsp;<input type="date" name="end_date" id="end_date">
<br/>
<br/>
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
<button type ="submit" name ="action" value="foreclose"><b>foreClose</b></button>
</font>
