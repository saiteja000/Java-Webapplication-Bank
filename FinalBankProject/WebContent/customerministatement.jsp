...
<b> Account :</b>&emsp;&emsp;&emsp;<input type ="text" value =<%=session.getAttribute("customer")%>  name="senderaccount"  readonly >
<br/>
<br/>
<b>From Date:</b> &emsp;&emsp;<input type ="date" name="fromdate" id ="fromdate">
<br/>
<br/>
<b>To Date:</b> &emsp;&emsp;&emsp;<input type ="date" name="todate" id ="todate">
<br/>
<br/>
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
<button type ="submit" name ="action" value="ministatement"><b>GENERATE MINI STATEMENT</b></button>
</font>
