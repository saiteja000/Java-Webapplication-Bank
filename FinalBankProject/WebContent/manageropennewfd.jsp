...
<ul>
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="manageropensbaccount.jsp">Open Savings Account</a>
   ...
   <li><a href="managerministmt.jsp">Statement</a></li>
...
<br/>
<div align="center">
<button type ="submit" name ="action" value="opennewfd"><b>ADD</b></button>
</div>
</form>
</div>
</div>
