...
Employee Id : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type ="text" readonly="readonly"  name="EmpId" id ="EmpId" >
<br/>
<br/>
...
Department Id : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type ="text" name="DeptId" id ="DeptId">
<br/>
<br/>
...
<br/>
<div align="center">
<button type ="submit" name ="action" value="addstaff"><b>ADD EMPLOYEE</b></button>
</div>
<br/>
<br/>
</div>
