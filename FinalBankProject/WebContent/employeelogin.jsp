...
<body>
 <div class="body"></div>
		...
		<div class="login1"><div style="float:left;width:20%;">
		...
		<form action="EmployeeController" method="post">
				...
				<center><input type="text" placeholder="Employee Id" name="employee_id"  title = "Employee ID must be 5 digits only" required> <br><br>
				<input type="password" placeholder="Password" name="password"><br><br>
				<input type="submit" value="EmpLogin" name="action">
