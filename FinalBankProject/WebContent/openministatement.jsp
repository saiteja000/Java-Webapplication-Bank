...
<b> Account :</b> &emsp;&emsp;&emsp;&emsp;&emsp;<input type ="text" value =<%=session.getAttribute("customer")%>  name="senderaccount"  readonly >
<br/>
<br/>

<b>From Date :</b>&emsp;&emsp;&emsp;&emsp;<input type ="date"  name="fromdate" id="fromdate">
<br/>
<br/>

<b>To Date :</b>&emsp;&emsp;&emsp;&emsp;&emsp; <input type="date" name="todate" id="todate">
<br/>
<br/>
<br/>
<br/>
<div align="center">
<button type ="submit" name ="action" value="ministatement">GENERATE MINI STATEMENT</button>
</div>
</form>
</div>
</body>
