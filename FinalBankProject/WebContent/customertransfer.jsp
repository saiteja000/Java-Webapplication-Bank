...
<b>Reciever Account Number  :</b>&emsp;&emsp; <input type ="text" name="receiversaccount" id ="receiversaccount" >
<br/>
<br/>
<b>Amount :</b> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type ="text" name="amount" id="amount">
<br/>
<br/>

<b>Sender Account : </b>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type ="text" value=<%=session.getAttribute("customer") %>  name="senderaccount" readonly>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br/>
<br/>
<div align="center">
<button type ="submit" name ="action" value="transfer"><b>TRANSFER</b></button>
</font>
</div>
</div>
</form>
