...
<center><b>Fixed Deposit Account details</b></center> 
<table border=1>
<tr>
<th>Customer_id</th>
<th>Account_id</th>
...
<c:set var = "fdd"  value="${sessionScope.fddetails}" />
      

<tr>
<td><c:out value="${fdd.fcustomer_id}"></c:out></td>
<td><c:out value="${fdd.faccount_id}"></c:out></td>
<td><c:out value="${fdd.startDate}"></c:out></td>
<td><c:out value="${fdd.endDate}"></c:out></td>
<td><c:out value="${fdd.roi}"></c:out></td>
<td><c:out value="${fdd.amount}"></c:out></td>
<td><c:out value="${fdd.maturityamount}"></c:out></td>
</tr>
