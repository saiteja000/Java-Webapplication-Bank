...
<tr>
<td><c:out value="${details.customer_id}"></c:out></td>
<td><c:out value="${details.customer_name}"></c:out></td>
<td><c:out value="${details.customer_age}"></c:out></td>
<td><c:out value="${details.panNumber}"></c:out></td>
<td><c:out value="${details.password}"></c:out></td>
</tr>
